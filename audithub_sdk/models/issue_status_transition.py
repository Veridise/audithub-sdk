...
class IssueStatusTransition(BaseModel):
    ...
    to_status: StrictStr
    extra: ExtraFunctionArguments
    created_by: StrictStr
    created_at: datetime
    __properties: ClassVar[List[str]] = ["issue_id", "function", "from_status", "to_status", "extra", "created_by", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "extra": ExtraFunctionArguments.from_dict(obj["extra"]) if obj.get("extra") is not None else None,
