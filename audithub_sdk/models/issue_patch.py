...
class IssuePatch(BaseModel):
    ...
    IssuePatch
    """ # noqa: E501
    action: Optional[IssueAction] = None
    delete: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["action", "delete"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": IssueAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
