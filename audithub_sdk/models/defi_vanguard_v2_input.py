...
class DefiVanguardV2Input(BaseModel):
    """
    DefiVanguardV2Input
    """ # noqa: E501
    ...
    parameters: DefiVanguardV2Parameters = Field(description="The parameters to pass to DeFi Vanguard v2")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "parameters": DefiVanguardV2Parameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
