...
class ZKVanguardInput(BaseModel):
    """
    ZKVanguardInput
    """ # noqa: E501
    ...
    parameters: ZKVanguardParameters = Field(description="The parameters to pass to ZK Vanguard")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "parameters": ZKVanguardParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
