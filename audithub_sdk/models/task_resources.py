...
class TaskResources(BaseModel):
    ...
    id: StrictInt
    resources: Resources
    steps: List[StepResources]
    __properties: ClassVar[List[str]] = ["id", "resources", "steps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "steps": [StepResources.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None
        })
        return _obj
