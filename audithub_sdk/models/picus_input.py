...
class PicusInput(BaseModel):
    ...
    parameters: PicusParameters = Field(description="The parameters to pass to Picus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "parameters": PicusParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
