...
class OnboardingRequest(BaseModel):
    ...
    OnboardingRequest
    """ # noqa: E501
    id: StrictInt = Field(description="The id of the onboarding request.")
    created_by: StrictStr = Field(description="The id of user that made the onboarding request.")
    created_at: datetime = Field(description="The date that the onboarding request has been created.")
    organization_id: Optional[StrictInt] = None
    approved_by: Optional[StrictStr] = None
    approved_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "created_by", "created_at", "organization_id", "approved_by", "approved_at"]
