...
class VersionData(BaseModel):
    ...
    VersionData
    """ # noqa: E501
    name: Optional[StrictStr] = 'initial'
    digest: Optional[StrictStr] = None
    commit_hash: Optional[StrictStr] = None
    data_path: StrictStr = Field(description="S3 reference relative to the package root")
    __properties: ClassVar[List[str]] = ["name", "digest", "commit_hash", "data_path"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name") if obj.get("name") is not None else 'initial',
