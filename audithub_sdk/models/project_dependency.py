...
class ProjectDependency(BaseModel):
    ...
    foundry: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["npm", "foundry"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if npm (nullable) is None
        # and model_fields_set contains the field
        if self.npm is None and "npm" in self.model_fields_set:
            _dict['npm'] = None

        # set to None if foundry (nullable) is None
        # and model_fields_set contains the field
        if self.foundry is None and "foundry" in self.model_fields_set:
            _dict['foundry'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "npm": NPMProjectDependency.from_dict(obj["npm"]) if obj.get("npm") is not None else None,
