...
class ZKVanguardV2Input(BaseModel):
    """
    ZKVanguardV2Input
    """ # noqa: E501
    ...
    parameters: ZKVanguardV2Parameters = Field(description="The parameters to pass to ZK Vanguard v2")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "parameters": ZKVanguardV2Parameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
