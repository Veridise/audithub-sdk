...
class StepDefinition(BaseModel):
    ...
    is_tool: Optional[StrictBool] = Field(default=False, description="Denotes if the step is running a tool. If false it's just a preparation step.")
    __properties: ClassVar[List[str]] = ["caption", "short_name", "is_tool"]
