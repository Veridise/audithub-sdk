...
class PicusV2Input(BaseModel):
    ...
    parameters: PicusV2Parameters = Field(description="The parameters to pass to PicusV2")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "parameters": PicusV2Parameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
